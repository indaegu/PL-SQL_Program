 ...
 * @author SCM
 * @설명:
 * Server에서 해당하는 데이만 가져온다.
 * 빈번한 Hard parsing을 개선하는 예제
 * Soft parsing 과 Hard Parsing 비교하여 제출산출물에 간단하게정리
 * 이하 Calc_Bonus_by_stmt_5와 동일하게 작성
...
public class Calc_Bonus_by_pstmt_1 {
    public static void execute(Connection conn) throws SQLException {
        ...
        try {
            System.out.println();
            System.out.println("========Calc_Bonus_by_pstmt_1 시작========");
            ...
            System.out.println("Calc_Bonus_by_pstmt_1 경과 시간 : " + (endTime - startTime) + "ms");
            System.out.println("========Calc_Bonus_by_pstmt_1 정상 종료========");
            System.out.println();

            // 4단계 검증 로직
            System.out.println("Calc_Bonus_by_pstmt_1 검증 진행중...");
            ...
            LogWriter.writeLog("Calc_Bonus_by_pstmt_1 에러 발생", e.getMessage());
