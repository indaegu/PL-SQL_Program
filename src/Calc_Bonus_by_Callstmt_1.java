 ...
 * @author SCM
 * @설명:
 * Anonymous Block으로 쿠폰 계산 로직 구현후 Java 의 Callable Statement 객체 사용
 * Cursor 사용 , 1 Row 단위 Fetch , 1 Row 단위 쿠폰 계산 , 1 Row 단위 Insert
 * 10,000 단위 commit
...
public class Calc_Bonus_by_Callstmt_1 {
    public static void execute(Connection conn) throws SQLException {
        ...
        try {
            System.out.println();
            System.out.println("========Calc_Bonus_by_Callstmt_1 시작========");
            ...
            System.out.println("Calc_Bonus_by_Callstmt_1 경과 시간 : " + (endTime - startTime) + "ms");
            System.out.println("========Calc_Bonus_by_Callstmt_1 정상 종료========");
            System.out.println();

            // 4단계 검증 로직
            System.out.println("Calc_Bonus_by_Callstmt_1 검증 진행중...");
