 ...
 * @author SCM
 * @설명:
 * 필터링을 Server에서 수행하여 필요한 고객 데이터만 가져온다.
 * Fetch size(Fetch 단위) 1000 으로변경 (다앙하게 10, 100, 1000, 10000 로 바꿔 가며 테스트)
 * defaultfetch size = 10 (직접 찾아보기)
 * 이하 4와 동일
...
public class Calc_Bonus_by_stmt_5 {
    public static void execute(Connection conn) throws SQLException {
        ...
        try {
            System.out.println();
            System.out.println("========Calc_Bonus_by_stmt_5 시작========");
            ...
            System.out.println("Calc_Bonus_by_stmt_5 경과 시간 : " + (endTime - startTime) + "ms");
            System.out.println("========Calc_Bonus_by_stmt_5 정상 종료========");
            System.out.println();

            // 4단계 검증 로직
            System.out.println("Calc_Bonus_by_stmt_5 검증 진행중...");
            ...
            System.out.println("Calc_Bonus_by_stmt_5 검증 완료");
            System.out.println();
            ...
            SendMail.goMail(SendMail.setting(new Properties(),"hanium124@naver.com","@hanium124"),
                    "Calc_Bonus_by_stmt_5 실행완료", mailContent);
