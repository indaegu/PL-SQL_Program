...
public class Calc_Bonus_by_stmt_3 {
    public static void execute(Connection conn) throws SQLException {
        ...
        try {
            System.out.println();
            System.out.println("========Calc_Bonus_by_stmt_3 시작========");
            ...
            System.out.println("Calc_Bonus_by_stmt_3 경과 시간 : " + (endTime - startTime) + "ms");
            System.out.println("========Calc_Bonus_by_stmt_3 정상 종료========");
            System.out.println();

            // 4단계 검증 로직
            System.out.println("Calc_Bonus_by_stmt_3 검증 진행중...");
            ...
            LogWriter.writeLog("Calc_Bonus_by_stmt_3 에러 발생", e.getMessage());
        }finally {
